    ...
    <article
      ...
      <div
        ...
        className={
          ...
          ' wow fadeInUp border bg-white dark:bg-[#1e1e1e] flex mb-4 flex-col h-[23rem] md:h-52 md:flex-row  group w-full dark:border-gray-600 hover:border-customYellow-600  dark:hover:border-customPurple-600 duration-300 transition-colors justify-between overflow-hidden rounded-xl'
        }>
        {/* 图片封面 */}
        {showPageCover && (
        ...
        <div
          ...
          <header>
            ...
            {post?.category && (
              <div
                className={`flex mb-1 items-center ${showPreview ? 'justify-center' : 'justify-start'} flex-wrap dark:text-gray-300 text-gray-600 hover:text-customYellow-700 dark:hover:text-customPurple-500`}>
                <Link
                  passHref
            ...
            <Link
              ...
              passHref
              className={
                ' group-hover:text-customYellow-700 dark:hover:text-customPurple-700 dark:group-hover:text-customPurple-600 text-black dark:text-gray-100  line-clamp-2 replace cursor-pointer text-xl font-extrabold leading-tight'
              }>
