...
function DarkModeBlockButton() {
  ...
  return (
    <button
      ...
      className={
        'group duration-200 hover:text-white hover:shadow-md hover:bg-customYellow-600 dark:hover:bg-customPurple-600 flex justify-between items-center px-2 py-2 border dark:border-gray-600 bg-white dark:bg-[#7b25d5]  rounded-lg'
      }>
...
function Button({ title, url }) {
  return (
    <Link
      href={url}
      className={
        'duration-200 hover:text-white hover:shadow-md flex cursor-pointer justify-between items-center px-2 py-2 border dark:border-gray-600 bg-white hover:bg-customYellow-600 dark:bg-[#1e1e1e] rounded-lg'
      }>
      {title}
    </Link>
  )
