              ...
              return (
                    ...
                    >
                        <div className={`${className || ''} 
                            ${selected ? 'text-white bg-customYellow-600 dark:bg-customPurple-600' : ''}  
                            flex items-center hover:bg-customYellow-600 dark:hover:bg-customPurple-600 hover:scale-110 hover:text-white rounded-lg px-2 py-0.5 duration-150 transition-all`}
                        >
