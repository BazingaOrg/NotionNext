  ...
  return (
    <div
      ...
      className={`wow fadeInUp flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1e1e1e]  
            ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-customYellow-600 dark:hover:border-customPurple-600 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}>
      <div
      ...
      <div id='category-bar-next' className='flex items-center justify-center'>
        <div
          id='right'
          className='cursor-pointer mx-2 dark:text-gray-300 dark:hover:text-customPurple-600 hover:text-customYellow-600'
        ...
        <Link
          href='/category'
          className='whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-customYellow-600 dark:hover:text-customPurple-600'>
...
const MenuItem = ({ href, name }) => {
  ...
  return (
    <div
      className={`whitespace-nowrap mr-2 duration-200 transition-all font-bold px-2 py-0.5 rounded-md text-gray-900 dark:text-white hover:text-white hover:bg-customYellow-600 dark:hover:bg-customPurple-600 ${selected ? 'text-white bg-customYellow-600 dark:bg-customPurple-600' : ''}`}>
